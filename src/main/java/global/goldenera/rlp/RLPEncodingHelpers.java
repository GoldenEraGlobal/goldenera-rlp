...
/**
 * Helper static methods to facilitate RLP encoding <b>within this package</b>.
 * Neither this class
...
class RLPEncodingHelpers {
  ...
  /**
   * Writes the result of encoding the provided value to the provided destination
   * (which must be big
   * enough).
   */
  ...
  /**
   * Writes the encoded header of a list provided its encoded payload size to the
   * provided
